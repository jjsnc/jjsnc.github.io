...
This challenge was a classic buffer overflow challenge, involving overwriting the return address of a function to jump to the "win" function.
...
| 16 bytes buffer | 8 bytes RBP | 8 bytes Return Address | <br>
