...
After you have installed the Windows 11 Eval Copy ISO, you can open a 2nd virtual machine (a 3rd one even) quite easily. Edit the settings for the VM as you have done for the Domain Controller/Windows Server 2022, locate the ISO file, and follow through with the installation steps.
...
![reassigning DNS preference](/images/Proj%3A%20AD/ipconfig2.png)

*Click on edit, and then input the static IP address that you have configured for the AD+DNS server*

![ipconfig again](/images/Proj%3A%20AD/ipconfig3.png)
...
![joining the domain](/images/Proj%3A%20AD/join.png)

*Input your forest/domain name*

![joining the domain2](/images/Proj%3A%20AD/join2.png)
...
![joining the domain3](/images/Proj%3A%20AD/join3.png)
...
![joining domain greyed out](/images/Proj%3A%20AD/lockedout.png)
...
![cannot join](/images/Proj%3A%20AD/join4.png) 

*Trying to log in with the newly created username and password within ADUC*

![cannot join](/images/Proj%3A%20AD/join5.png)
...
![logging into the domain](/images/Proj%3A%20AD/login.png)

![prompt new password](/images/Proj%3A%20AD/login2.png)

*This will pop up if you have selected the option that the user must change their password for their next login*

![logging into the domain](/images/Proj%3A%20AD/login3.png)

*Enter the old password alongside the new password you want*

![password complexity check](/images/Proj%3A%20AD/login4.png)
...
![confirmation](/images/Proj%3A%20AD/login5.png)
